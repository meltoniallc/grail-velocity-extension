...
(function (global) {
  ...
  function cashFromTape(velocity) {
    const value = velocity && velocity.fastCashPrice != null ? Number(velocity.fastCashPrice) : null;
    if (value == null || Number.isNaN(value)) return { value: null, source: "none" };
    return { value, source: "tape" };
  }
